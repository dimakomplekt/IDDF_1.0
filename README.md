...
Пара макросов iLogic, предназначенных для автозаполнения данных о составных частях изделий, проектируемых в Inventor, из .xlsx - ведомости состава изделия и передачи данных в чертежи изделий для автозаполнения основных надписей (**ГОСТ / ЕСКД - формат**).
